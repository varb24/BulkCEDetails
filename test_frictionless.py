...
def extract_and_save_errors(file_location: str, schema_location: str) -> dict:
    """
    ...
    rows_data = {}
    try:
        with open("./sample_data/sample_testing.csv", 'r', newline='') as f:
...
if __name__ == "__main__":
    ...
    error_info = extract_and_save_errors(data_source, schema_location)
